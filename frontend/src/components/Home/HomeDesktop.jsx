...
import usaFlag from "../../assets/indianflag.jpeg";

const HomeDesktop = ({ setIsTermsModal ,setchat}) => {
    return (
        <DesktopHome className='homeDesktop'>
            ...
            <HomeBottom>
                ...
                <div>
                    ...
                    <ButtonsWrapper>
                        <Button className='textBtn' onClick={() => { setIsTermsModal(true);setchat('chat') }}>Text</Button>
                        <p>or</p>
                        <Button className='textBtn' onClick={() => { setIsTermsModal(true);setchat('video') }}>Video</Button>
                    </ButtonsWrapper>
                </div>
            </HomeBottom>
